...
package cn.junln.framework.trace.autoconfigure;
...
import cn.junln.framework.trace.filter.TLogServletFilter;
import cn.junln.framework.trace.handler.TraceIdGenerator;
...
public class TraceAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[Junln Framework] - Auto Configuration 'Trace' completed initialization.");
    }
}
