...
package cn.junln.framework.data.autoconfigure.idgenerator;
...
public class MyBatisPlusIdGeneratorConfiguration {
    ...
    public static class Default {
        static {
            log.debug("[Junln Framework] - Auto Configuration 'MyBatis Plus-IdGenerator-Default' completed initialization.");
        }
    ...
    public static class CosId {
        static {
            log.debug("[Junln Framework] - Auto Configuration 'MyBatis Plus-IdGenerator-CosId' completed initialization.");
        }
