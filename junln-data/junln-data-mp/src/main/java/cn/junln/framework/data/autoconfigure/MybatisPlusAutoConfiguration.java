...
package cn.junln.framework.data.autoconfigure;
...
import cn.junln.framework.data.autoconfigure.idgenerator.MyBatisPlusIdGeneratorConfiguration;
import cn.junln.framework.data.handler.CompositeBaseEnumTypeHandler;
...
public class MybatisPlusAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[Junln Framework] - Auto Configuration 'MyBatis Plus' completed initialization.");
    }
}
