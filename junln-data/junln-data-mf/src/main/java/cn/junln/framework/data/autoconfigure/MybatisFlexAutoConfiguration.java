...
import cn.junln.framework.data.datapermission.DataPermissionDialect;
import cn.junln.framework.data.datapermission.DataPermissionFilter;
...
public class MybatisFlexAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[Junln Framework] - Auto Configuration 'MyBatis Flex' completed initialization.");
