...
package cn.junln.framework.extension.crud.autoconfigure;
...
import cn.junln.framework.extension.crud.aop.CrudApiAnnotationAdvisor;
import cn.junln.framework.extension.crud.aop.CrudApiAnnotationInterceptor;
...
public class CrudApiAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[Junln Framework] - Auto Configuration 'Extension-CRUD API' completed initialization.");
    }
}
