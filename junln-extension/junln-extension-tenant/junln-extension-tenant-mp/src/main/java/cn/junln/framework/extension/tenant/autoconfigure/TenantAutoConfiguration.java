...
package cn.junln.framework.extension.tenant.autoconfigure;
...
import cn.junln.framework.extension.tenant.annotation.ConditionalOnEnabledTenant;
import cn.junln.framework.extension.tenant.aop.TenantIgnoreAspect;
import cn.junln.framework.extension.tenant.config.TenantProvider;
import cn.junln.framework.extension.tenant.TenantDataSourceHandler;
import cn.junln.framework.extension.tenant.handler.datasource.DefaultTenantDataSourceHandler;
import cn.junln.framework.extension.tenant.handler.datasource.TenantDataSourceAdvisor;
import cn.junln.framework.extension.tenant.handler.datasource.TenantDataSourceInterceptor;
import cn.junln.framework.extension.tenant.handler.line.DefaultTenantLineHandler;
...
public class TenantAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[Junln Framework] - Auto Configuration 'Tenant' completed initialization.");
    }
}
