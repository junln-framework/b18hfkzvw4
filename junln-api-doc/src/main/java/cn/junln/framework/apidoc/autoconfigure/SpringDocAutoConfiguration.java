...
package cn.junln.framework.apidoc.autoconfigure;
...
import cn.junln.framework.apidoc.processor.BaseEnumProcessor;
import cn.junln.framework.core.autoconfigure.application.ApplicationProperties;
...
public class SpringDocAutoConfiguration implements WebMvcConfigurer {
    ...
    public void postConstruct() {
        log.debug("[Junln Framework] - Auto Configuration 'ApiDoc' completed initialization.");
    }
}
