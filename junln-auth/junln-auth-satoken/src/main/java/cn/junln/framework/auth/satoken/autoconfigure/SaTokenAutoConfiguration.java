...
package cn.junln.framework.auth.satoken.autoconfigure;
...
import cn.junln.framework.auth.satoken.autoconfigure.dao.SaTokenDaoConfiguration;
...
public class SaTokenAutoConfiguration implements WebMvcConfigurer {
    ...
    public void postConstruct() {
        log.debug("[Junln Framework] - Auto Configuration 'SaToken' completed initialization.");
    }
}
