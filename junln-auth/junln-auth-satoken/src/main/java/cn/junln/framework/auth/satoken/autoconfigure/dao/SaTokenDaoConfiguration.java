...
package cn.junln.framework.auth.satoken.autoconfigure.dao;
...
public class SaTokenDaoConfiguration {
    ...
    public static class Default {
        static {
            log.debug("[Junln Framework] - Auto Configuration 'SaToken-Dao-Default' completed initialization.");
        }
    ...
    public static class Redis {
        static {
            log.debug("[Junln Framework] - Auto Configuration 'SaToken-Dao-Redis' completed initialization.");
        }
