...
package cn.junln.framework.auth.justauth.autoconfigure;
...
import cn.junln.framework.auth.justauth.state.RedisAuthStateCache;
...
abstract class JustAuthStateCacheConfiguration {
    ...
    static class Redis {
        static {
            log.debug("[Junln Framework] - Auto Configuration 'JustAuth-AuthStateCache-Redis' completed initialization.");
        }
    ...
    static class Default {
        static {
            log.debug("[Junln Framework] - Auto Configuration 'JustAuth-AuthStateCache-Default' completed initialization.");
        }
    ...
    static class Custom {
        static {
            log.debug("[Junln Framework] - Auto Configuration 'JustAuth-AuthStateCache-Custom' completed initialization.");
        }
