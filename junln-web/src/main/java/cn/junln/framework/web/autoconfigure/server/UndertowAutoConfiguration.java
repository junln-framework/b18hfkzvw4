...
package cn.junln.framework.web.autoconfigure.server;
...
import cn.junln.framework.core.util.CollUtils;
...
public class UndertowAutoConfiguration {
    ...
    public WebServerFactoryCustomizer<UndertowServletWebServerFactory> customize(ServerExtensionProperties properties) {
        return factory -> {
            ...
            log.debug("[Junln Framework] - Disallowed HTTP methods on Server Undertow: {}.", properties
                .getDisallowedMethods());
            log.debug("[Junln Framework] - Auto Configuration 'Web-Server Undertow' completed initialization.");
        };
    }
}
