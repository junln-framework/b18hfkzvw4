...
package cn.junln.framework.captcha.graphic.autoconfigure;
...
import cn.junln.framework.captcha.graphic.core.GraphicCaptchaService;
...
public class GraphicCaptchaAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[Junln Framework] - Auto Configuration 'Captcha-Graphic' completed initialization.");
    }
}
