...
package cn.junln.framework.core.autoconfigure.threadpool;
...
import cn.junln.framework.core.exception.BaseException;
...
class TaskExecutionConfiguration {
    ...
    static class AsyncThreadPoolConfigurer implements AsyncConfigurer {
        ...
        public void postConstruct() {
            log.debug("[Junln Framework] - Auto Configuration 'TaskExecutor-@Async' completed initialization.");
        }
    }

    @PostConstruct
    public void postConstruct() {
        log.debug("[Junln Framework] - Auto Configuration 'TaskExecutor' completed initialization.");
    }
}
