...
import cn.junln.framework.log.handler.InterceptorLogHandler;
import cn.junln.framework.log.filter.LogFilter;
import cn.junln.framework.log.handler.LogHandler;
import cn.junln.framework.log.interceptor.LogInterceptor;
...
public class LogAutoConfiguration implements WebMvcConfigurer {
    ...
    public void postConstruct() {
        log.debug("[Junln Framework] - Auto Configuration 'Log-Interceptor' completed initialization.");
    }
}
