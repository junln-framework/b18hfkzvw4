...
package cn.junln.framework.encrypt.password.encoder.autoconfigure;
...
import cn.junln.framework.encrypt.password.encoder.enums.PasswordEncoderAlgorithm;
import cn.junln.framework.encrypt.password.encoder.util.PasswordEncoderUtil;
...
public class PasswordEncoderAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[Junln Framework] - Auto Configuration 'Encrypt-Password Encoder' completed initialization.");
    }
}
