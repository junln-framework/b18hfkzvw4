...
package cn.junln.framework.encrypt.field.autoconfigure;
...
import cn.junln.framework.encrypt.field.interceptor.MyBatisDecryptInterceptor;
import cn.junln.framework.encrypt.field.interceptor.MyBatisEncryptInterceptor;
import cn.junln.framework.encrypt.field.util.EncryptHelper;
...
public class FieldEncryptAutoConfiguration {
    ...
    public void postConstruct() {
        ...
        log.debug("[Junln Framework] - Auto Configuration 'Encrypt-Field' completed initialization.");
    }
}
