...
package cn.junln.framework.cache.redisson.autoconfigure;
...
import cn.junln.framework.cache.redisson.handler.NameMapperHandler;
...
public class RedissonAutoConfiguration {
    ...
    public RedissonAutoConfigurationCustomizer redissonAutoConfigurationCustomizer() {
        return config -> {
            ...
            log.debug("[Junln Framework] - Auto Configuration 'Redisson' completed initialization.");
        };
    }
