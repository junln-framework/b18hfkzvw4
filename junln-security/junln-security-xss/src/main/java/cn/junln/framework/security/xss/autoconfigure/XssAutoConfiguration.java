...
package cn.junln.framework.security.xss.autoconfigure;
...
import cn.junln.framework.security.xss.filter.XssFilter;
...
public class XssAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[Junln Framework] - Auto Configuration 'Security-XSS' completed initialization.");
    }
}
