...
package cn.junln.framework.security.xss.filter;
...
import cn.junln.framework.security.xss.autoconfigure.XssProperties;
...
public class XssFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) {
        log.debug("[Junln Framework] - Auto Configuration 'Web-XssFilter' completed initialization.");
    }
