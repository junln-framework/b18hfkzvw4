...
package cn.junln.framework.messaging.mail.autoconfigure;
...
import cn.junln.framework.core.util.MapUtils;
...
public class MailAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[Junln Framework] - Auto Configuration 'Mail' completed initialization.");
    }
}
