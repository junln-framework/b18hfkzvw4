...
package cn.junln.framework.messaging.mqtt.autoconfigure;
...
import cn.junln.framework.messaging.mqtt.autoconfigure.properties.*;
import cn.junln.framework.messaging.mqtt.constant.MqttConstant;
import cn.junln.framework.messaging.mqtt.handler.MqttMessageInboundHandler;
import cn.junln.framework.messaging.mqtt.handler.MqttShutdownHandler;
import cn.junln.framework.messaging.mqtt.msg.MqttMessageConsumer;
import cn.junln.framework.messaging.mqtt.msg.MqttMessageProducer;
import cn.junln.framework.messaging.mqtt.strategy.MqttOptions;
import cn.junln.framework.messaging.mqtt.strategy.MqttTemplate;
...
public class MqttAutoConfiguration {
    ...
    public void postConstruct() {
        log.info("[Junln Framework] - Auto Configuration 'MQTT' completed initialization.");
    }
}
