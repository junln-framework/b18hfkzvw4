...
package cn.junln.framework.messaging.websocket.autoconfigure;
...
import cn.junln.framework.messaging.websocket.core.WebSocketClientService;
import cn.junln.framework.messaging.websocket.core.WebSocketInterceptor;
import cn.junln.framework.messaging.websocket.dao.WebSocketSessionDao;
import cn.junln.framework.messaging.websocket.dao.WebSocketSessionDaoDefaultImpl;
...
public class WebSocketAutoConfiguration {
    ...
    public WebSocketHandler webSocketHandler(WebSocketSessionDao webSocketSessionDao) {
        return new cn.junln.framework.messaging.websocket.core.WebSocketHandler(properties, webSocketSessionDao);
    }
    ...
    public void postConstruct() {
        log.debug("[Junln Framework] - Auto Configuration 'Messaging-WebSocket' completed initialization.");
    }
}
