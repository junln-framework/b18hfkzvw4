...
package cn.junln.framework.storage.autoconfigure;
...
import cn.junln.framework.storage.annotation.PlatformProcessor;
import cn.junln.framework.storage.autoconfigure.properties.StorageProperties;
import cn.junln.framework.storage.core.FileStorageService;
import cn.junln.framework.storage.engine.StorageDecoratorManager;
...
import cn.junln.framework.storage.processor.preprocess.impl.*;
import cn.junln.framework.storage.engine.StorageStrategyRegistrar;
...
import cn.junln.framework.storage.service.impl.DefaultFileRecorder;
...
public class StorageAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[Junln Framework] - Auto Configuration 'Storage' completed initialization.");
    }
}
