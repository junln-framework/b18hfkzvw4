...
package cn.junln.framework.json.jackson.autoconfigure;
...
import cn.junln.framework.core.enums.BaseEnum;
import cn.junln.framework.core.util.GeneralPropertySourceFactory;
import cn.junln.framework.json.jackson.serializer.BaseEnumDeserializer;
import cn.junln.framework.json.jackson.serializer.BaseEnumSerializer;
import cn.junln.framework.json.jackson.serializer.BigNumberSerializer;
import cn.junln.framework.json.jackson.serializer.SimpleDeserializersWrapper;
...
public class JacksonAutoConfiguration {
    ...
    public Jackson2ObjectMapperBuilderCustomizer jackson2ObjectMapperBuilderCustomizer() {
        return builder -> {
            ...
            log.debug("[Junln Framework] - Auto Configuration 'Jackson' completed initialization.");
        };
    }
    ...
    private SimpleModule bigNumberModule() {
        ...
        switch (properties.getBigNumberSerializeMode()) {
            ...
            default -> log.warn("[Junln Framework] - Jackson 大数值序列化模式：NO_OPERATE，超过 JS 范围的数值会损失精度");
        }
